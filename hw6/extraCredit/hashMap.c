...
{  
	/*write this*/	
	//preserving linked lists while removing:
	//for loop to find index i when the strcmp is true
	//then use that to have previous and next for preserving LL
	int index = 0;
	if(HASHING_FUNCTION == 1)
		index = (stringHash1(k) % ht->tableSize);
	if(HASHING_FUNCTION == 2)
